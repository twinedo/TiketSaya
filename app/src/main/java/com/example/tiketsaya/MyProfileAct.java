...
public class MyProfileAct extends AppCompatActivity {
    ...
    Button button_edit_profile, btn_back_home, btn_signout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_edit_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoEditprofile = new Intent(MyProfileAct.this, EditProfileActivity.class);
        ...
        btn_signout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent gotoHome = new Intent(MyProfileAct.this, SignInActivity.class);
                startActivity(gotoHome);
                finish();
            }
        });
